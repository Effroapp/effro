    ...
    >
      ...
      <div style={{ padding: '20px 22px 18px' }}>
        ...
        <h2 style={{
          ...
          fontSize: isFirst || isCommitment ? '1.125rem' : '1rem',
          fontWeight: 600,
          letterSpacing: '-.02em',
          lineHeight: 1.3,
        ...
        {step.email && (
          <a
            ...
            style={{
              ...
              fontFamily: "'Geist Mono', monospace",
              fontSize: '0.75rem', letterSpacing: '.04em',
              color: 'var(--mint, var(--mint))',
              textDecoration: 'none',
            }}
          >
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginTop: 18 }}>
          ...
          <button
            ...
            style={{
              ...
              cursor: 'pointer', fontSize: '0.8125rem', fontWeight: isLast ? 600 : 400,
          ...
          <div style={{ textAlign: 'center', marginTop: 10 }}>
            <button
              ...
              style={{
                ...
                fontFamily: "'Geist Mono', monospace",
                fontSize: '0.6875rem', letterSpacing: '.14em', textTransform: 'uppercase',
